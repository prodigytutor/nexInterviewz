...
function AddNewInterview() {
    ...
    const onSubmit=async(e)=>{
        ...
        const InputPrompt="Job position: "+jobPosition+", Job Description: "+jobDesc+", Years of Experience : "+jobExperience+" , Depends on Job Position, Job Description & Years of Experience give us "+process.env.NEXT_PUBLIC_INTERVIEW_QUESTION_COUNT+" Interview question along with Answer in JSON format, Give us question and answer field in JSON. Only return the question and answer json nothing else do not return an explanation"
  ...
  return (
    <div>
        ...
        <DialogContent className="max-w-2xl">
            <DialogHeader >
            <DialogTitle className="text-2xl" >Tell us more about the job your are interviewing for</DialogTitle>
            <DialogDescription>
